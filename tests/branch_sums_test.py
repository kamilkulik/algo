...
@pytest.mark.parametrize('tree, branch_sums_array', test_cases)
def test_branch_sums_1(tree, branch_sums_array):

    binary_tree = build_binary_tree(tree)

    assert branch_sums(binary_tree) == branch_sums_array