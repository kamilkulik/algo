import pytest
from src.ceasar_cipher_encryptor.ceasar_cipher_encryptor import ceasar_cipher_encryptor

test_cases = [
    ("kjwmntauvjjnmsagwgawkagfuaugjhawgnawgjhawjgawbfawghesh", 15, "zylbcipjkyycbhpvlvplzpvujpjvywplvcplvywplyvplquplvwthw"),
    ("mvklahvjcnbwqvtutmfafkwiuagjkzmzwgf", 7, "zylbcipjkyycbhpvlvplzpvujpjvywplvcplvywplyvplquplvwthw"),
